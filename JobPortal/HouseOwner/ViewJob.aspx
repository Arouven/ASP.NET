<%@ Page Title="Viewing Job" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ViewJob.aspx.vb" Inherits="JP.ViewJob1" %>
  ...
  <div class="form">
    ...
    <div class="section-padding-100-0">
      ...
      <div style="width: 80%; margin: auto;">
        ...
        <div class="row form-group">
          ...
          <div class="col-sm-4">
            <asp:Label ID="LabelSalary" runat="server"></asp:Label>
				...
				<div class="col-sm-9">
					 <asp:CheckBox ID="CheckBoxvacant" runat="server" Enabled="false" />
				</div>
			</div>
        <div class="row form-group">
          <div class="col-sm-3"></div>
        ...
        <br />
        <div class="row form-group">
          <asp:LinkButton CssClass="btn btn-primary col-sm-3 float-left" OnClick="btnUpdate_Click" ID="btUpdate" Text="Update Job" runat="server" ValidationGroup="ViewMaterialAddGroup" />
