<%@ Page Title="Home" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="index.aspx.vb" Inherits="JP.index" %>
    ...
    <div class="dez-bnr-inr dez-bnr-inr-md" style="background-image: url(images/main-slider/slide2.jpg);">
      <div class="container">
        ...
        <%--     <div class="find-job-bx">
            ...
            <h2>Search Between More Them
              <br />
              <span class="text-primary">50,000</span> Open Jobs.</h2>
      ...
      <div class="container">
        <%--  <div class="row">
          <div class="col-lg-12 section-head text-center">
            ...
            <h6 class="fw4 m-b0">
            20+ Featured Cities Added Jobs</h6>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-9">
              ...
              <a href="#">
                <div class="d-flex m-b30">
                  <div class="job-post-company">
                    <span>
                      <img src="images/logo/icon1.png" /></span>
                  </div>
                  <div class="job-post-info">
                    <h4>
                      <asp:Label ID="LabelJobTitle1" runat="server" Text="Expert cleaner"></asp:Label></h4>
                    <ul>
                      <li><i class="fa fa-map-marker"></i>Mauritius,
                        <asp:Label ID="LabelJobLocation1" runat="server" Text="Mauritius"></asp:Label></li>
                      <li><i class="fa fa-clock-o"></i>Posted on
                        <asp:Label ID="LabelDatePosted1" runat="server" Text="10/12/2021"></asp:Label></li>
                    </ul>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="job-time mr-auto">
                    <span>
                      <asp:Label ID="LabelCategory1" runat="server" Text="Mob"></asp:Label></span>
                  </div>
                  <div class="salary-bx">
                    <span>Rs.
                      <asp:Label ID="LabelSalary1" runat="server" Text="10000"></asp:Label></span>
                  </div>
                </div>
            ...
            <li>
              <a href="#">
                <div class="d-flex m-b30">
                  ...
                  <div class="job-post-info">
                    <h4>
                      <asp:Label ID="LabelJobTitle2" runat="server" Text="Expert cleaner"></asp:Label></h4>
                    <ul>
                      <li><i class="fa fa-map-marker"></i>Mauritius,
                        <asp:Label ID="LabelJobLocation2" runat="server" Text="Mauritius"></asp:Label></li>
                      <li><i class="fa fa-clock-o"></i>Posted on
                        <asp:Label ID="LabelDatePosted2" runat="server" Text="10/12/2021"></asp:Label></li>
                    </ul>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="job-time mr-auto">
                    <span>
                      <asp:Label ID="LabelCategory2" runat="server" Text="Mob"></asp:Label></span>
                  </div>
                  <div class="salary-bx">
                    <span>Rs.
                      <asp:Label ID="LabelSalary2" runat="server" Text="10000"></asp:Label></span>
                  </div>
                </div>
                <%--<span class="post-like fa fa-heart-o"></span>--%>
              </a>
            ...
            <li>
              <a href="#">
                <div class="d-flex m-b30">
                  ...
                  <div class="job-post-info">
                    <h4>
                      <asp:Label ID="LabelJobTitle3" runat="server" Text="Expert cleaner"></asp:Label></h4>
                    <ul>
                      <li><i class="fa fa-map-marker"></i>Mauritius,
                        <asp:Label ID="LabelJobLocation3" runat="server" Text="Mauritius"></asp:Label></li>
                      <li><i class="fa fa-clock-o"></i>Posted on
                        <asp:Label ID="LabelDatePosted3" runat="server" Text="10/12/2021"></asp:Label></li>
                    </ul>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="job-time mr-auto">
                    <span>
                      <asp:Label ID="LabelCategory3" runat="server" Text="Mob"></asp:Label></span>
                  </div>
                  <div class="salary-bx">
                    <span>Rs.
                      <asp:Label ID="LabelSalary3" runat="server" Text="10000"></asp:Label></span>
                  </div>
                </div>
                <%--<span class="post-like fa fa-heart-o"></span>--%>
              </a>
            ...
            <li>
              <a href="#">
                <div class="d-flex m-b30">
                  ...
                  <div class="job-post-info">
                    <h4>
                      <asp:Label ID="LabelJobTitle4" runat="server" Text="Expert cleaner"></asp:Label></h4>
                    <ul>
                      <li><i class="fa fa-map-marker"></i>Mauritius,
                        <asp:Label ID="LabelJobLocation4" runat="server" Text="Mauritius"></asp:Label></li>
                      <li><i class="fa fa-clock-o"></i>Posted on
                        <asp:Label ID="LabelDatePosted4" runat="server" Text="10/12/2021"></asp:Label></li>
                    </ul>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="job-time mr-auto">
                    <span>
                      <asp:Label ID="LabelCategory4" runat="server" Text="Mob"></asp:Label></span>
                  </div>
                  <div class="salary-bx">
                    <span>Rs.
                      <asp:Label ID="LabelSalary4" runat="server" Text="10000"></asp:Label></span>
                  </div>
                </div>
                <%--<span class="post-like fa fa-heart-o"></span>--%>
              </a>
            ...
            <li>
              <a href="#">
                <div class="d-flex m-b30">
                  ...
                  <div class="job-post-info">
                    <h4>
                      <asp:Label ID="LabelJobTitle5" runat="server" Text="Expert cleaner"></asp:Label></h4>
                    <ul>
                      <li><i class="fa fa-map-marker"></i>Mauritius,
                        <asp:Label ID="LabelJobLocation5" runat="server" Text="Mauritius"></asp:Label></li>
                      <li><i class="fa fa-clock-o"></i>Posted on
                        <asp:Label ID="LabelDatePosted5" runat="server" Text="10/12/2021"></asp:Label></li>
                    </ul>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="job-time mr-auto">
                    <span>
                      <asp:Label ID="LabelCategory5" runat="server" Text="Mob"></asp:Label></span>
                  </div>
                  <div class="salary-bx">
                    <span>Rs.
                      <asp:Label ID="LabelSalary5" runat="server" Text="10000"></asp:Label></span>
                  </div>
                </div>
                <%--<span class="post-like fa fa-heart-o"></span>--%>
              </a>
          ...
          <div class="m-t30">
            <div class="d-flex">
              <a class="site-button button-sm" runat="server" href="~/register.aspx">Create an Account </a>
            </div>
          </div>
        </div>
        <%--   <div class="col-lg-3">
