...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="container">
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
			<ContentTemplate>
				<asp:ListView ID="lvMovies" runat="server" ItemPlaceholderID="itemPlaceholder" DataKeyNames="StudentId" ClientIDMode="Static">
					<ItemTemplate>
						<div class="card h-100" style="width: 195px; float: left; margin: 8px;">
							...
							<div class="card-body">
								...
								<asp:HyperLink CssClass="btn btn-primary" runat="server" NavigateUrl='<%#Eval("StudentId", "~/Admin/UserDetails.aspx?user=Student&id={0}")%>'>Details</asp:HyperLink>
							</div>
						</div>
					</ItemTemplate>
					<LayoutTemplate>
