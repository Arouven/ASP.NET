  ...
  Inherits System.Web.UI.Page
	...
	Private Sub sendMail(sentFrom As String, senderMailPassword As String, sendTo As String, welcomeUsername As String, profilePicUrl As String, clickHereLoginUrl As String)
		...
		Try
			...
			msgBody.Append("Dear " + welcomeUsername + ", your account profile has been successfully updated.")
	...
	Private Function UsernameExistInTutorTable(userName As String)
		Dim con As New SqlClient.SqlConnection(_conString)
		Dim cmd As New SqlClient.SqlCommand()
		cmd.CommandType = CommandType.Text
	...
	Protected Sub ButtonRegister_Click(sender As Object, e As EventArgs)
		...
		If (FileUpload1.HasFile) Then
			...
			If (CheckFileType(FileUpload1.FileName)) Then
				...
				ElseIf (UsernameExistInTutorTable(TextBoxUsernameReg.Text)) Then
					lblStatus.Text = "Username Already Exist, Please Choose Another"
					lblStatus.ForeColor = System.Drawing.Color.Red
					TextBoxUsernameReg.Focus()


					'ElseIf (EmailExistInTable("HouseKeeperTable", TextBoxEmail.Text)) OrElse (EmailExistInTable("AdminTable", TextBoxEmail.Text)) Then
					'	lblStatus.Text = "Email Already in use, Please Choose Another"
					'	lblStatus.ForeColor = System.Drawing.Color.Red
					'	TextBoxUsernameReg.Focus()
					'ElseIf (EmailExistInTutorTable(TextBoxEmail.Text)) Then
					'	lblStatus.Text = "Email Already in use, Please Choose Another"
					'	lblStatus.ForeColor = System.Drawing.Color.Red
					'	TextBoxUsernameReg.Focus()
				Else
					...
					cmd1.CommandText = "update HouseOwnerTable set 
															FirstName=@FirstName, 
															LastName=@LastName, 
					...
					cmd1.Parameters.AddWithValue("@HOid", HOId)
					con1.Open()
