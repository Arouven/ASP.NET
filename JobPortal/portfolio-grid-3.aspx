<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="portfolio-grid-3.aspx.vb" Inherits="JP.portfolio_grid_3" %>
    ...
    <div class="dez-bnr-inr overlay-black-middle" style="background-image: url(images/banner/bnr2.jpg);">
      <div class="container">
        <div class="dez-bnr-inr-entry">
          <h1 class="text-white">Portfolio Grid 3</h1>
          <!-- Breadcrumb row -->
        ...
        <div class="container">
          ...
          <div class="clearfix">
            <ul id="masonry" class="dez-gallery-listing gallery-grid-4 gallery mfp-gallery sp10">
              <li class="web design card-container col-lg-4 col-md-4 col-sm-4 col-6">
              ...
              <li class="advertising branding photography card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
              ...
              <li class="branding design photography card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
                  <div class="dez-media dez-img-overlay1 dez-img-effect">
                    <a href="javascript:void(0);">
              ...
              <li class="web branding card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
                  <div class="dez-media dez-img-overlay1 dez-img-effect">
                    <a href="javascript:void(0);">
              ...
              <li class="advertising design photography card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
                  <div class="dez-media dez-img-overlay1 dez-img-effect ">
                    <a href="javascript:void(0);">
              ...
              <li class="web photography card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
                  <div class="dez-media dez-img-overlay1 dez-img-effect">
                    <a href="javascript:void(0);">
              ...
              <li class="advertising branding card-container col-lg-4 col-md-4 col-sm-4 col-6">
                <div class="dez-box dez-gallery-box">
                  <div class="dez-media dez-img-overlay1 dez-img-effect">
                    <a href="javascript:void(0);">
                      <img src="images/gallery/pic1.jpg" alt="">
