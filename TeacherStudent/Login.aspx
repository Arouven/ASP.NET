	...
	<div class="login-page">
		<form class="form" runat="server">
			<div class="register-form">
				<asp:TextBox ID="TextBoxUsernameReg" runat="server" placeholder="Username"></asp:TextBox>
				<asp:TextBox ID="TextBoxPasswordReg" runat="server" TextMode="Password" placeholder="Password"></asp:TextBox>
				<asp:TextBox ID="TextBoxEmail" runat="server" TextMode="Email" placeholder="Email adderss"></asp:TextBox>
