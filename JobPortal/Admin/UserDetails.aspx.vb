Public Class UserDetails
	...
	Protected Sub LinkButtonDelete_Click(sender As Object, e As EventArgs)
		If deleteUser() Then : Response.Redirect("~/AdminViewsListOfHOHK.aspx")
	...
	Private Function deleteUser() As Boolean
		...
		If requestUser = "HO" Then
			tableName = "HouseOwnerTable"
			tableId = "HOId"
		ElseIf requestUser = "HK" Then
			tableName = "HouseKeeperTable"
			tableId = "HKId"
		End If
	...
	Protected Sub LinkButtonResetPassword_Click(sender As Object, e As EventArgs)
		...
		If requestUser = "HO" Then
			tableName = "HouseOwnerTable"
			tableId = "HOId"
			profileUpdateUrl = ClassSendMail.hoProfileUpdateUrl
		ElseIf requestUser = "HK" Then
			tableName = "HKTable"
			tableId = "HKId"
			profileUpdateUrl = ClassSendMail.hkProfileUpdateUrl
		End If
	...
	Private Sub sendResetPasswordMail(sentFrom As String, senderMailPassword As String, sendTo As String, username As String, profilePicUrl As String, clickHereUrl As String)
		...
		Try
			...
			msgBody.Append("Dear " + username + ", Admin has reset your password, thank you for staying on MoCoolMaid.")
