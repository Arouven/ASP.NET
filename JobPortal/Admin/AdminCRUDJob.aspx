<%@ Page Title="List of Jobs" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="AdminCRUDJob.aspx.vb" Inherits="JP.AdminCRUDJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="breadcumb-area bg-img">
		<div class="bradcumbContent">
			<h2 style="text-align:center;">List Of Jobs</h2>
		</div>
	</div>
						...
						<ItemTemplate>
							<asp:UpdatePanel runat="server" ID="updatePanel000">
								<ContentTemplate>
									...
									&nbsp;&nbsp;
								<asp:LinkButton ID="btnViewCourse" CssClass="btn btn-light" href='<%#Eval("JobId", "/Admin/ViewJob.aspx?id={0}")%>' runat="server" Text="View" ToolTip="View Course"><span class="glyphicon glyphicon-eye-open"></span></asp:LinkButton>
									&nbsp;&nbsp;
								<%--<asp:LinkButton ID="btnUpdate" CssClass="btn btn-warning" href='<%#Eval("JobId", "/Admin/UpdateJob.aspx?id={0}")%>' runat="server" Text="Update" ToolTip="Update Course"><span class="glyphicon glyphicon-edit"></span></asp:LinkButton>--%>
								</ContentTemplate>
							</asp:UpdatePanel>
						</ItemTemplate>
					</asp:TemplateField>
