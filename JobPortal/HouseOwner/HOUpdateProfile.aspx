<%@ Page Title="Update My Profile" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="HOUpdateProfile.aspx.vb" Inherits="JP.HOUpdateProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="breadcumb-area bg-img" >
		<div class="bradcumbContent">
			<h2 style="text-align:center">Update My Profile</h2>
	...
	<div class="section-padding-100-0">
		<div class="register-page" style="margin: auto; width: 80%;">
			<div class="form register-form">
				...
				<asp:Button ID="ButtonRegister" ValidationGroup="registerGroup" CssClass="btn btn-warning" runat="server" Text="Update" OnClick="ButtonRegister_Click" />
