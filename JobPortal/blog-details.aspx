<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="blog-details.aspx.vb" Inherits="JP.blog_details" %>
          ...
          <div class="col-lg-8 col-md-7 m-b10">
            ...
            <div class="blog-post blog-single blog-style-1">
              ...
              <div class="dez-post-media dez-img-effect zoom-slow m-t20"><a href="#">
                <img src="images/blog/default/thum1.jpg" alt=""></a> </div>
              <div class="dez-post-text">
                ...
                <p>
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard text 
                                    ...
                                    It has urvived not only five centuries, but also the leap into electronic typesetting.
                </p>
                <blockquote>
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Has been the industry's standard text ever since 
                                    the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimencenturies.
                </blockquote>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard text 
                                    ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen  
                    ...
                    <li class="comment">
                      <div class="comment-body">
                        <div class="comment-author vcard">
                          ...
                          <cite class="fn">Stacy poe</cite> <span class="says">says:</span> </div>
          ...
          <div class="col-lg-4 col-md-5 sticky-top">
            <aside class="side-bar">
              ...
              <div class="widget widget_gallery gallery-grid-3">
                ...
                <ul>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic2.jpg" alt=""></a></div>
                  </li>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic1.jpg" alt=""></a></div>
                  </li>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic5.jpg" alt=""></a></div>
                  </li>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic7.jpg" alt=""></a></div>
                  </li>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic8.jpg" alt=""></a></div>
                  </li>
                  <li>
                    <div class="dez-post-thum"><a href="#" class="dez-img-overlay1 dez-img-effect zoom-slow">
                      <img src="images/gallery/pic9.jpg" alt=""></a></div>
                  </li>
                </ul>
              </div>
