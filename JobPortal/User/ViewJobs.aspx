<%@ Page Title="Job Lists" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ViewJobs.aspx.vb" Inherits="JP.ViewJobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="breadcumb-area bg-img" >
		<div class="bradcumbContent">
			<h2 style="text-align:center">All Jobs Available</h2>
		</div>
	</div>
	...
	<div class="container">
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
			<ContentTemplate>
				<asp:ListView ID="lvMovies" runat="server" ItemPlaceholderID="itemPlaceholder" DataKeyNames="jobid" ClientIDMode="Static">
					<ItemTemplate>
						<div class="card h-100" style="width: 195px; float: left; margin: 8px;">
							<asp:image runat="server" ID="Image1"  imageurl="~/images/logo/icon1.png"  class="card-img-top" alt="Card image" Width="193px" Height="195px"></asp:image>
							<div class="card-body">
								...
								<p class="card-text">
									<span><strong>Salary:<br />
									</strong></span><%# Eval("Salary")%>
								</p>
								<%--Eval movie_id as the commandargument--%>
								<asp:LinkButton ID="LinkButtonDescription" runat="server" Text="Details" CommandArgument='<%#Eval("JobId") %>' OnClick="LinkButtonDescription_Click" CommandName="btnAccess" CssClass="btn btn-primary" />
							</div>
						</div>
					</ItemTemplate>
					<LayoutTemplate>
