<%@ Page Title="Job Category" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="AdminCRUDCategory.aspx.vb" Inherits="JP.AdminCRUDCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="tbldiv">
    ...
    <br />
    <asp:LinkButton ID="btnAdd" CssClass="btn btn-info col-sm-2" rel="modal:open" data-toggle="modal" OnClientClick="return OpenMod();" href="#modAddCategory" runat="server" Text="Add" ToolTip="Add Category">Add&nbsp;&nbsp;<span class="glyphicon glyphicon-plus"></span></asp:LinkButton>
    <br />
    <br />
  </div>
        ...
        <div class="modal-dialog modal-dialog-center">
          ...
          <div class="modal-content">
            <div class="modal-header" style="text-align: center; background-color: white;">
              <button type="button" class="modal-title close" style="color: black; cursor: not-allowed; font-size: large; font-weight: bolder; pointer-events: none;">Add Category</button>
    ...
    <ContentTemplate>
      <div class="modal fade" id="modUpdateCategory" role="dialog">
        <div class="modal-dialog modal-dialog-center">
          ...
          <div class="modal-content">
            <div class="modal-header" style="text-align: center; background-color: white;">
              <button type="button" class="modal-title close"style="color: black; cursor: not-allowed; font-size: large; font-weight: bolder; pointer-events: none;">Update Category</button>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
              <asp:UpdatePanel runat="server">
    ...
    $(document).ready(function () {
      $(`#<%=TextBoxUpdateCategory.ClientID%>`).keyup(function () {
        ...
        if (categoryName.length >= 1) {
          $('#emptyMessage').text('');
          $.ajax({
            url: 'WebServiceCategory.asmx/CategoryNameExists',
            method: 'post',
