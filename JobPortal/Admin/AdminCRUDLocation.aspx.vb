Public Class AdminCRUDLocation
  Inherits System.Web.UI.Page
	...
	Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
		...
		con.Open()
		cmd.CommandType = CommandType.Text
		cmd.CommandText = "delete from LocationTable where LocationId=@LocationId;"
		cmd.Parameters.AddWithValue("@LocationId", Convert.ToInt32(CType(sender, LinkButton).CommandArgument))
		cmd.ExecuteNonQuery()
		con.Close()
		GetCourseCategory()
	End Sub
	...
	Protected Sub UpdateButton_Click(sender As Object, e As EventArgs)
		...
		Else
			...
			con.Open()
			cmd.CommandType = CommandType.Text
			cmd.CommandText = "update LocationTable set LocationName=@LocationName where LocationId=@LocationId;"
			cmd.Parameters.AddWithValue("@LocationId", idToUpdate)
			cmd.Parameters.AddWithValue("@LocationName", nameToUpdate)
			cmd.ExecuteNonQuery()
			con.Close()
	...
	Protected Sub AddButton_Click(sender As Object, e As EventArgs)
		If TextBoxAddCategory.Text.Trim.Length > 0 Then
			...
			cmd.Parameters.AddWithValue("@LocationName", TextBoxAddCategory.Text.Trim)
			cmd.ExecuteNonQuery()
			con.Close()
			Response.Redirect(Request.RawUrl)
		End If
