...
Public Class master1
	...
	'	Else
	'		'delete content of password field
	'		ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Pop", "loginModal();", True)
	'		lblStatus.Text = "Wrong password or username or your account has been suspended!"
	'		lblStatus.ForeColor = System.Drawing.Color.Red
	'	End If
	'End Sub
	Private Sub sendMail(sentFrom As String, senderMailPassword As String, sendTo As String, welcomeUsername As String, profilePicUrl As String, clickHereLoginUrl As String, FileUpload1 As FileUpload)
